// // This has been copied from CMPS 383.
...
//   console.log(
//     "Certificates already configured - delete .env.development.local if you want to regenerate"
//   );
//   process.exit(0);
// }
...
//   : (() => {
//       console.error(
//         "Could not locate a folder to store your SSL certificates in"
//       );
//       process.exit(-1);
//     })();
...
//     } else {
//       console.error(
//         "Failed to create your certificate - see errors from dotnet"
//       );
//     }
//     process.exit(code);
//   });
